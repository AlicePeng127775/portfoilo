    ...
    <div class='allProject container'>
        ...
        <div class='project grid' data-aos="fade-left">
            ...
            <div class='projectInfo col-12 col-6-lg'>
                ...
                <div class='toolC'><span class='tool'>HTML</span> <span class='tool'>CSS</span> <span class='tool'>JavaScript</span> <span class='tool'>Visual Studio Code</span> <span class='tool'>Figma</span></div>
        ...
        <div class='project grid' data-aos="fade-right">
            ...
            <div class='projectInfo col-12 col-6-lg'>
                ...
                <div class='toolC'>
                    ...
                    <span class='tool'>Visual Studio Code</span> 
                    <span class='tool'>Illusttretor</span>
                </div>
        ...
        <div class='project grid' data-aos="fade-left">
            ...
            <div class='projectInfo col-12 col-6-lg'>
                ...
                <div class='toolC'><span class='tool'>Figma</span> <span class='tool'>Maze</span></div>
