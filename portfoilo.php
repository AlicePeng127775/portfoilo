...
<body>
    ...
    <div class='allProject container'>
        <div class='project grid' data-aos="fade-right">
            <div class='projectImg col-12 col-6-sm col-6-lg'><img src='./img/project/project1.png' alt="little fish cares website"></div>
            <div class='projectInfo col-12 col-6-sm col-6-lg'>
        ...
        <div class='project grid' data-aos="fade-left">
            <div class='projectImg col-12 col-6-sm col-6-lg'><img src='./img/project/project2.png'  alt="Lumina online shopping Website"></div>
            <div class='projectInfo col-12 col-6-sm col-6-lg'>
        ...
        <div class='project grid' data-aos="fade-right">
            <div class='projectImg col-12 col-6-sm col-6-lg'><img src='./img/project/project3.png' alt="Whac-A-Mole Website Game"></div>
            <div class='projectInfo col-12 col-6-sm col-6-lg'>
        ...
        <div class='project grid' data-aos="fade-left">
            <div class='projectImg col-12 col-6-sm col-6-lg'><img src='./img/project/project4.png' alt="October shopping app design"></div>
            <div class='projectInfo col-12 col-6-sm col-6-lg'>
